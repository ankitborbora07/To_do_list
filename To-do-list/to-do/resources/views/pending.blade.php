...
<head>
  ...
  />
    ...
    <style>
        ...
        body{
          background: url("https://wallpapers.com/images/featured/white-plain-background-cxs6kmx3wgbnzz0x.jpg");
...
<body>
    ...
    <div class="container">
      <h3>Hi, {{$user['name']}}. Your pending tasks are-</h3>
        <div class="d-flex justify-content-between align-items-center my-5">
            <div class="h1">Pending tasks:</div>
        ...
        @if(isset($pendingTasks) && !$pendingTasks)
        <div style="display: flex; justify-content: center; ">
        <h1 class="animate__animated animate__lightSpeedInLeft">There are no pending tasks.</h1>
    </div>
    @endif
    ...
    @if(isset($pendingTasks) && $pendingTasks)
        <table class="table table-stripped table-dark custom-rounded-table animate__animated animate__zoomIn">
            ...
            <td style="vertical-align: middle;width:120px"><button id="del" class="btn-danger btn-sm"><i class="fa-solid fa-trash"></i></button><a href="{{"edit/".$item['id']}}"><button id="upd" class="btn-primary btn-sm"><i class="fa-solid fa-pen"></i></button></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
